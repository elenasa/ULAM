...
namespace MFM {
  ...
  Ui_Ut_102323Int Uq_1010919AtomUtils<EC, POS>::Uf_7getType(UlamContext<EC> & uc, T& Uv_4self, Ui_Ut_102964Atom<EC> Uv_1a)
  {
    T & atom = Uv_1a.getRef();
  ...
  template<class EC, u32 POS>
  Ui_Ut_102964Atom<EC> Uq_1010919AtomUtils<EC, POS>::Uf_3new(UlamContext<EC> & uc, T& Uv_4self, Ui_Ut_102323Int Uv_1t)
  {
