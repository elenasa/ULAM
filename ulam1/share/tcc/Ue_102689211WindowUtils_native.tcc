...
namespace MFM {
  ...
  template<class CC>
  Ui_Ut_102328Unsigned Uf_9212getLastIndex(T& Uv_4self, Ui_Ut_10138Unsigned Uv_6radius)
  {
  ...
  template<class CC>
  Ui_Ut_102328Unsigned Uf_9213getFirstIndex(T& Uv_4self, Ui_Ut_10138Unsigned Uv_6radius)
  {
    u32 radius = Uv_6radius.read();
