...
namespace MFM{
  ...
  void Uq_10104Fail10<EC,POS>::Uf_4fail(const UlamContext<EC> & uc, T& Uv_4self)
  {
    s32 code = -1;
  ...
  template<class EC, u32 POS>
  void Uq_10104Fail10<EC,POS>::Uf_4fail(const UlamContext<EC> & uc, T& Uv_4self, Ui_Ut_102321i Uv_4code)
  {
