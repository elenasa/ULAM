...
namespace MFM{
  ...
  public:
    ...
    u32 findMatchingFunction(std::vector<UTI> argTypes, SymbolFunction *& funcSymbol);

    u32 findMatchingFunctionWithConstantsAsArgs(std::vector<UTI> argTypes, std::vector<Node*> constArgs, SymbolFunction *& funcSymbol);
