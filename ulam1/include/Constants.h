...
#define SIZEOFACHAR 8
  ...
  enum STORAGE { IMMEDIATE = 0, EVENTWINDOW, STACK, EVALRETURN, UNPACKEDSTRUCT, TMPREGISTER, TMPBITVAL, TMPAUTOREF};
...
#define WritePacked(p) (p == PACKED || p == PACKEDLOADABLE)
  ...
  enum ALT { ALT_NOT = 0, ALT_AS, ALT_HAS, ALT_REF, ALT_ARRAYITEM}; //autolocaltype
