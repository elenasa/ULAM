...
namespace MFM {
  ...
  NodeTypeDescriptorSelect::NodeTypeDescriptorSelect(TypeArgs targs, UTI auti, NodeTypeDescriptor * node, CompilerState & state) : NodeTypeDescriptor(targs, auti, state), m_nodeSelect(node)
  {
    if(m_nodeSelect)
