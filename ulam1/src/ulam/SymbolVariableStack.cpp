...
namespace MFM {
  ...
  SymbolVariableStack::SymbolVariableStack(Token id, UTI utype, s32 slot, CompilerState& state) : SymbolVariable(id, utype, state), m_stackFrameSlotIndex(slot), m_autoStgTypeForEval(Nouti) {}
