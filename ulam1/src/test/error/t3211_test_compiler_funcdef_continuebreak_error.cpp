...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3211_test_compiler_funcdef_continuebreak_error)
  {
    std::string GetAnswerKey()
    {
      /*
	A.ulam:8:2: ERROR: Continue statement not within loop.
	Warning: EMPTY STATEMENT!! when in doubt, count.
	A.ulam:9:2: ERROR: Unexpected input!! Token: <TOK_KW_ELSE>.
	Warning: EMPTY STATEMENT!! when in doubt, count.
  ...
  ENDTESTCASECOMPILER(t3211_test_compiler_funcdef_continuebreak_error)
