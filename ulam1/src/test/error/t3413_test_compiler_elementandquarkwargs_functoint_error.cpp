...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3413_test_compiler_elementandquarkwargs_functoint_error)
  {
  ...
  ENDTESTCASECOMPILER(t3413_test_compiler_elementandquarkwargs_functoint_error)
