...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3499_test_compiler_elementandquark_arraytypedeffromanotherclass_unseen_error)
  {
  ...
  ENDTESTCASECOMPILER(t3499_test_compiler_elementandquark_arraytypedeffromanotherclass_unseen_error)
