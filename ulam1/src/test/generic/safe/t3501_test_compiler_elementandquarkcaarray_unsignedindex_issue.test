...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3501_test_compiler_elementandquarkcaarray_unsignedindex_issue)
  {
    std::string GetAnswerKey()
    {
      ...
      return std::string("Exit status: 0\nUe_Foo { Bool(3) b(false);  typedef Bar Pop[2];  Int(4) m_i(0);  Bar m_bar2[2]( typedef Unsigned(6) Index;  Bool(1) val_b[3](false,false,false);  typedef Unsigned(6) Index;  Bool(1) val_b[3](false,false,false); );  Bar sbar( typedef Unsigned(6) Index;  Bool(1) val_b[3](false,false,false); );  Int(32) test() {  Atom(96) a;  a sbar 4 cast [] = sbar 5 cast [] a = a sbar 2 cast [] = Gah g;  a sbar g [] = 0 cast return } }\nUq_Bar { typedef Unsigned(6) Index;  Bool(1) val_b[3](false,false,false);  <NOMAIN> }\nUq_Gah { /* empty class block */ }");
    }
    ...
    std::string PresetTest(FileManagerString * fms)
    {
      ...
      bool rtn3 = fms->add("Gah.ulam"," ulam 1;\n quark Gah {\n //no toInt on purpose\n }\n");
