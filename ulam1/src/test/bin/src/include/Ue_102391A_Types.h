...
#ifndef Ud_Ui_Ut_10174Bool
#define Ud_Ui_Ut_10174Bool
namespace MFM{
  struct Ui_Ut_10174Bool
  {
    typedef BitField<BitVector<32>, VD::BOOL, 7, 25> BF;
    BitVector<32> m_stg;
    Ui_Ut_10174Bool() : m_stg() { }
    Ui_Ut_10174Bool(const u32 d) : m_stg(d) {}
    Ui_Ut_10174Bool(const Ui_Ut_10174Bool& d) : m_stg(d.m_stg) {}
    ~Ui_Ut_10174Bool() {}
    const u32 read() const { return BF::Read(m_stg); }
    void write(const u32 v) { BF::Write(m_stg, v); }
  };
} //MFM
#endif /*Ud_Ui_Ut_10174Bool */
...
#ifndef Ud_Ui_Ue_102391A
#define Ud_Ui_Ue_102391A
namespace MFM{

  template<class CC> class Ue_102391A;  //forward

  template<class CC>
  struct Ui_Ue_102391A
  {
    typedef typename CC::ATOM_TYPE T;
    typedef typename CC::PARAM_CONFIG P;
    enum { BPA = P::BITS_PER_ATOM };
    typedef Ue_102391A<CC> Us;
    T m_stg;  //storage here!
    Ui_Ue_102391A() : m_stg() { }
    Ui_Ue_102391A(const T d) : m_stg(d) {}
    Ui_Ue_102391A(const Ui_Ue_102391A<CC>& d) : m_stg(d.m_stg) {}
    ~Ui_Ue_102391A() {}
    const T read() const { return m_stg; }
    void write(const T v) { m_stg = v; }
    BitVector<BPA>& getBits() { return m_stg.GetBits(); }
...
#endif /*Ud_Ui_Ue_102391A */

#ifndef Ud_Ui_Ue_102391A4auto
#define Ud_Ui_Ue_102391A4auto
namespace MFM{

  template<class CC>
  struct Ui_Ue_102391A4auto : public Ui_Ue_102391A<CC>
  {
    typedef typename CC::ATOM_TYPE T;
    typedef typename CC::PARAM_CONFIG P;
    enum { BPA = P::BITS_PER_ATOM };
    ...
    T& m_stgToChange;  //ref to storage here!
    Ui_Ue_102391A4auto(T & realStg) : m_stgToChange(realStg) {}
    ~Ui_Ue_102391A4auto() { m_stgToChange = Ui_Ue_102391A<CC>::m_stg; }
  };
} //MFM
#endif /*Ud_Ui_Ue_102391A4auto */
