...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3159_test_compiler_unarybitwiseand)
  {
    ...
    {
      return std::string("Ue_A { Unary(3) a(2);  Unary(3) b(1);  Unary(3) c(1);  Int(3) e(2);  Int(3) f(1);  Int(3) g(0);  Int(32) test() {  a e 2 cast = cast = b f 1 cast = cast = c a b & = g e f & = c cast return } }\nExit status: 1");
    }
    
    std::string PresetTest(FileManagerString * fms)
    {
      // a is 2 bits; b is 1 bit; a & b = 1 bit; notice as Int.3 (g), 2 & 1 = 0
