...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3146_test_compiler_element)
  {
    std::string GetAnswerKey()
    {
      return std::string("Ue_Foo { Int m_i;  Int test() {  Foo f;  f m_i . 3 = f ( 1 )check . f m_i . return } }\nExit status: 3");
    }
  ...
  ENDTESTCASECOMPILER(t3146_test_compiler_element)
