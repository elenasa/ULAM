  ...
  BEGINTESTCASECOMPILER(t3348_test_compiler_elementandquarkswclassargs2_typedeffromanotherclasstypedef_sizeof)
  {
    std::string GetAnswerKey()
    {
      ...
      */
      ...
      return std::string("Exit status: 1\nUe_P { Bool(UNKNOWN) b(unknown);  constant Unsigned(32) a = NONREADYCONST;  Int(32) foo(0);  Int(32) test() {  System s;  3u = var const P(1u) pel;  s ( pel b sizeof . . )print . s ( P sizeof . )print . s ( pel sizeof . )print . pel b sizeof . . cast return } }\nUq_Q { constant Int(32) s = NONREADYCONST;  typedef Unsigned(UNKNOWN) Foo;  <NOMAIN> }\nUq_V { typedef Q(3) Woof;  <NOMAIN> }\nUq_System { <NOMAIN> }\n");
    }
