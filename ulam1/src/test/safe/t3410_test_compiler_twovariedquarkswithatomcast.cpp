  ...
  BEGINTESTCASECOMPILER(t3410_test_compiler_twovariedquarkswithatomcast)
  {
    std::string GetAnswerKey()
    {
      ...
      */
      ...
      return std::string("Exit status: 0\nUe_Foo { IntXY(1u,4u) q( constant Unsigned(32) xbits = 1;  constant Unsigned(32) ybits = 4;  typedef IntXY(1u,4u) Self;  typedef Int(1) XCoord;  typedef Int(4) YCoord;  Int(1) x(0);  Int(4) y(0); );  IntXY(3u,4u) n( constant Unsigned(32) xbits = 3;  constant Unsigned(32) ybits = 4;  typedef IntXY(3u,4u) Self;  typedef Int(3) XCoord;  typedef Int(4) YCoord;  Int(3) x(2);  Int(4) y(3); );  IntXY(2u,3u) p( constant Unsigned(32) xbits = 2;  constant Unsigned(32) ybits = 3;  typedef IntXY(2u,3u) Self;  typedef Int(2) XCoord;  typedef Int(3) YCoord;  Int(2) x(0);  Int(3) y(0); );  Int(32) test() {  System s;  IntXY(3u,4u) m;  m n ( 1 2 )make . = s ( m x . )print . s ( m y . )print . m n ( 2 3 )fromXY . = s ( n x . )print . s ( n y . )print . s ( m x . )print . s ( m y . )print . 0 return } }\nUq_IntXY { constant Unsigned(32) xbits = NONREADYCONST;  constant Unsigned(32) ybits = NONREADYCONST;  typedef IntXY(xbits,ybits) Self;  typedef Int(UNKNOWN) XCoord;  typedef Int(UNKNOWN) YCoord;  Int(UNKNOWN) x(0);  Int(UNKNOWN) y(0);  <NOMAIN> }\nUq_System { <NOMAIN> }\n");
    }
