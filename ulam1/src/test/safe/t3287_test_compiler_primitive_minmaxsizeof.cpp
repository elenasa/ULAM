  ...
  BEGINTESTCASECOMPILER(t3287_test_compiler_primitive_minmaxsizeof)
  {
    std::string GetAnswerKey()
    {
      ...
      */
      ...
      return std::string("Exit status: 0\nUe_Fu { System s();  Int(32) test() {  Int(4) z;  s ( 4u )print . s ( -8 )print . s ( 7 )print . Unsigned(32) y;  s ( 32u )print . s ( 0u )print . s ( 4294967295u )print . Unary(3) x;  s ( 3u )print . s ( 0u )print . s ( 7u )print . Bool(3) v;  s ( 3u )print . s ( false )print . s ( false )print . Bits(2) t;  s ( 2u )print . 0u cast return } }\nUq_System { <NOMAIN> }\n");
    }
