  ...
  BEGINTESTCASECOMPILER(t3287_test_compiler_primitive_minmaxsizeof)
  {
    std::string GetAnswerKey()
    {
      ...
      */
      ...
      return std::string("Exit status: 0\nUe_Fu { System s();  Int(32) test() {  Int(4) z;  s ( 4u )print . s ( -8 )print . s ( 7 )print . Unsigned(32) y;  s ( 32u cast )print . s ( 0u cast )print . s ( 4294967295u )print . Unary(3) x;  s ( 3u )print . s ( 0u )print . s ( 7u )print . Bool(3) v;  s ( 3u )print . s ( 0u )print . s ( 7u )print . Bits(2) t;  s ( 2u )print . 0u cast return } }\nUq_System { <NOMAIN> }\n");
    }

    std::string PresetTest(FileManagerString * fms)
    {
      bool rtn1 = fms->add("Fu.ulam", "ulam 1;\nuse System;\nelement Fu {\nSystem s;\nInt test(){\nInt(4) z; s.print(z.sizeof);\n s.print(z.minof);\n s.print(z.maxof);\nUnsigned y;\n s.print((Unsigned) y.sizeof);\n s.print((Unsigned) y.minof);\n s.print(y.maxof);\nUnary(3) x;\n s.print(x.sizeof);\n s.print(x.minof);\n s.print(x.maxof);\n Bool(3) v;\n s.print(v.sizeof);\n s.print(v.minof);\n s.print(v.maxof);\nBits(2) t;\n s.print(t.sizeof);\n /*i = t.minof;\n unsupported request minof Bits */  return Void.sizeof;\n}\n}\n");
