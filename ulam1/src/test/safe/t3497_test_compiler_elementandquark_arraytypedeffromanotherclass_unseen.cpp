...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3497_test_compiler_elementandquark_arraytypedeffromanotherclass_unseen)
  {
  ...
  ENDTESTCASECOMPILER(t3497_test_compiler_elementandquark_arraytypedeffromanotherclass_unseen)
