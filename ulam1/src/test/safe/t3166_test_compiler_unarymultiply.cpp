...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3166_test_compiler_unarymultiply)
  {
    std::string GetAnswerKey()
    {
	 ...
	 Unary(3) Arg: 0x3
      */
      return std::string("Exit status: 3\nUe_A { Unary(3) b(2);  System s();  Bool(1) sp(false);  Unary(3) a(2);  Unary(3) c(3);  Int(32) test() {  a 2 cast = b 2 cast = c a cast cast b cast cast * cast = s ( c )print . c cast return } }\nUq_System { <NOMAIN> }\n");
    }
