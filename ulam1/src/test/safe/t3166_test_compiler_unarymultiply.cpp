...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3166_test_compiler_unarymultiply)
  {
    ...
    {
      //Ue_A { Unary(3) a(2);  Unary(3) b(2);  Unary(3) c(3);  Int(32) test() {  a 2 cast = b 2 cast = c a cast b cast * cast = c cast return } }\nExit status: 3
      return std::string("Ue_A { Unary(3) b(2);  System s();  Bool(1) sp(false);  Unary(3) a(2);  Unary(3) c(3);  Int(32) test() {  a 2 cast = b 2 cast = c a cast b cast * cast = s ( c )print . c cast return } }\nExit status: 3");
    }
