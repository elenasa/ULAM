...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3153_test_compiler_typebitsize)
  {
    std::string GetAnswerKey()
    {
      ...
      return std::string("Exit status: 0\nUe_C { Bool(1) a(true);  Int(3) m_i[4](2,3,0,0);  Int(6) m_u(15);  Bool(3) b(true);  Int(32) test() {  m_i 0 [] 2 cast = m_u 15 cast = m_i 1 [] m_u cast = b m_i 0 [] cast = b m_i 0 [] cast &= a b cast = 0 cast return } }\n");
    }
