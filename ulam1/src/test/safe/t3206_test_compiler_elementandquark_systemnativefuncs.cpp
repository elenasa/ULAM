...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3206_test_compiler_elementandquark_systemnativefuncs)
  {
    ...
    {
      return std::string("Ue_Foo { System m_s();  Bool(3) b(false);  Int(4) i(0);  Int(4) j(15);  Int(32) test() {  i 0 cast = j ( i cast 1 cast -b cast )update = m_s ( j cast )print . m_s ( j )print . j cast return } }\nExit status: -1");
    }
    ...
    {      
      ...
      // test system quark with native overloaded print funcs and assert
