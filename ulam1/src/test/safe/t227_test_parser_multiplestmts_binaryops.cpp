...
namespace MFM {
  ...
  BEGINTESTCASEPARSER(t227_test_parser_multiplestmts_binaryops)
  {
    ...
    {
      return std::string(" { Int a(1);  Int b(1);  Int c(1);  Int d(1);  Int e(2);  Int f(0);  Int g(1);  Int h(1);  Int main() {  a b c d 1 = = = = e a b +b = f a b -b = g c d * = h d d / = } }\n");
    }
    ...
    std::string PresetTest(FileManagerString * fms)
    {
      ...
      bool rtn1 = fms->add("a.ulam","ulam{Int a, b, c, d, e, f, g, h; Int main() { a = b = c = d = 1; e = a + b; f = a - b; g = c * d; h = d / d;} }"); 
