...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3256_test_compiler_funccalltypedefarg_issue)
  {
    std::string GetAnswerKey()
    {
      ...
      return std::string("Exit status: 1\nUe_TypedefIssue { typedef Unsigned(3) Symmetry;  Bool(1) b(true);  Unsigned(3) m(0);  Int(32) test() {  TypedefIssue t;  t ( 0 cast )set . cond b true = if t ( 1 cast )set . cond b true = if t m . cast return } }\n");
    }
