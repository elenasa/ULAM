...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3341_test_compiler_elementandquarkswclassargs_typedeffromanotherclasstypedef)
  {
  ...
  ENDTESTCASECOMPILER(t3341_test_compiler_elementandquarkswclassargs_typedeffromanotherclasstypedef)
