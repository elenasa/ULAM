...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3269_test_compiler_quark_arraytypedeffromanotherclass)
  {
  ...
  ENDTESTCASECOMPILER(t3269_test_compiler_quark_arraytypedeffromanotherclass)
