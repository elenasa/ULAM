...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3393_test_compiler_typedefarray_arithbitsize_issue)
  {
    ...
    {
      return std::string("Exit status: 7\nUe_B { typedef Unsigned(2) Slot;  typedef Unsigned(8) Index;  typedef Unsigned(8) IndArr[4];  Unsigned(8) arr[4](0,7,0,0);  Int(32) test() {  ( 1 cast 7u cast )hit arr 1 [] cast return } }\n");
    }
