...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3208_test_compiler_elementandquark_accessaquarkinsideaquark)
  {
    std::string GetAnswerKey()
    {
      ...
      */
      //constant fold minus
      return std::string("Exit status: 0\nUe_Foo { Bool(1) b(false);  System m_s();  Int(4) i(0);  Int(4) j(6);  Bar m_bar( Bool(1) b(false);  System m_s();  Unsigned(4) x(0);  Unsigned(4) y(0);  Gah m_gah( Bool(1) b(false);  System m_s();  Int(4) a(2);  Int(4) d(14); ); );  Int(32) test() {  m_bar m_gah ( 2 -2 )set . . j m_bar m_gah . ( )toInt . cast = m_s ( j )print . 0 return } }\nUq_Bar { Bool(1) b(false);  System m_s();  Unsigned(4) x(0);  Unsigned(4) y(6);  Gah m_gah( Bool(1) b(false);  System m_s();  Int(4) a(0);  Int(4) d(0); );  <NOMAIN> }\nUq_System { <NOMAIN> }\nUq_Gah { Bool(1) b(false);  System m_s();  Int(4) a(0);  Int(4) d(6);  <NOMAIN> }\n");
    }
