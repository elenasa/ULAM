...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3158_test_compiler_booladd)
  {
    ...
    {
      return std::string("Exit status: 1\nUe_A { Bool(3) b(false);  System s();  Bool(1) sp(false);  Bool(3) a(true);  Bool(3) c(true);  Unary(3) d(1);  Int(32) test() {  a true cast = b false cast = c a cast b cast +b cast = s ( c )print . d c cast = s ( d )print . c cast return } }\nUq_System { <NOMAIN> }\n");
    }
