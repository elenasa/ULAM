...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3161_test_compiler_unarybitwisexor)
  {
    std::string GetAnswerKey()
    {
	 ...
	 Unsigned Arg: 3
      */
      return std::string("Exit status: 1\nUe_A { Unary(3) b(1);  System s();  Unary(3) a(2);  Unary(3) c(1);  Unsigned(2) e(2);  Unsigned(2) f(1);  Unsigned(2) g(3);  Int(32) test() {  a e 2 cast = cast = b f 1 cast = cast = c a b ^ = s ( c )print . g e f ^ = s ( g cast )print . c cast return } }\nUq_System { <NOMAIN> }\n");
    }
