...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3402_test_compiler_twotypedefarrays)
  {
    ...
    {
      return std::string("Exit status: 7\nUe_B { typedef Unsigned(2) Slot;  typedef Unsigned(8) Index;  typedef Unsigned(8) IndArr[4];  typedef Unsigned(8) IndArrTwo[2];  Unsigned(8) arr[4](0,7,0,0);  Unsigned(8) arr2[2](0,7);  Int(32) test() {  ( 1 cast 7u cast )hit arr2 1 [] arr 1 [] = arr 1 [] cast return } }\n");
    }
