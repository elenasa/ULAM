...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3187_test_compiler_elementandquark_twoargscast)
  {
    ...
    {
      return std::string("Exit status: 36\nUe_Foo { System s();  Bool(7) sp(false);  Int(32) m_idx(40);  Int(6) m_x(9);  Int(6) m_y(4);  Int(32) test() {  m_x 9 cast = m_y 4 cast = m_idx ( m_x cast m_y cast )func = s ( m_idx )print . s ( m_x cast m_y cast * )print . m_x cast m_y cast * return } }\nUq_C2D { Int(6) m_width(0);  Int(6) m_height(0);  <NOMAIN> }\nUq_System { <NOMAIN> }\n");
    }
