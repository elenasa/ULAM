...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3207_test_compiler_elementandquark_inside_a_quark)
  {
    std::string GetAnswerKey()
    {
      ...
      return std::string("Exit status: -1\nUe_Foo { Bool(1) b(false);  System m_s();  Gah m_gah( Bool(1) b(false);  System m_s();  Int(4) a(4);  Int(4) d(4); );  Int(4) i(0);  Int(4) j(15);  Bar m_bar( Bool(1) b(true);  System m_s();  Unsigned(3) x(3);  Unsigned(3) y(0);  Gah m_gah( Bool(1) b(false);  System m_s();  Int(4) a(0);  Int(4) d(0); ); );  Int(32) test() {  i 0 cast = j ( i cast 1 -b )update = m_s ( j cast )print . m_s ( j )print . m_bar ( 3 -1 )set . m_gah ( 4 4 )set . j cast return } }\nUq_Bar { Bool(1) b(false);  System m_s();  Unsigned(3) x(0);  Unsigned(3) y(3);  Gah m_gah( Bool(1) b(true);  System m_s();  Int(4) a(9);  Int(4) d(1); );  <NOMAIN> }\nUq_System { <NOMAIN> }\nUq_Gah { Bool(1) b(false);  System m_s();  Int(4) a(0);  Int(4) d(15);  <NOMAIN> }\n");
    }
