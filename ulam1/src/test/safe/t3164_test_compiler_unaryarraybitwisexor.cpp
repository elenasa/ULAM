...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3164_test_compiler_unaryarraybitwisexor)
  {
    ...
    {
      return std::string("Ue_A { typedef Unary(3) Mu[2];  Unary(3) a[2](2,1);  Unary(3) b[2](0,2);  Unary(3) c[2](2,1);  Int(32) test() {  a 0 [] 3 cast = a 1 [] 2 cast = b 0 [] 0 cast = b 1 [] 6 cast = c a b ^ = c 0 [] cast return } }\nExit status: 2");
    }
