...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3157_test_compiler_unaryarrayadd)
  {
    ...
    {
      return std::string("Ue_A { typedef Unary(3) Mu[2];  Unary(3) a[2](2,1);  Unary(3) b[2](3,1);  Unary(3) c[2](3,2);  Int(32) test() {  a 0 [] 3 cast = a 1 [] 2 cast = b 0 [] 7 cast = b 1 [] 8 cast = c a b +b = c 0 [] cast return } }\nExit status: 3");
    }
