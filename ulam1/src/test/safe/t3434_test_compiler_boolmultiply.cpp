  ...
  BEGINTESTCASECOMPILER(t3434_test_compiler_boolmultiply)
  {
    std::string GetAnswerKey()
    {
      ...
      */
      ...
      return std::string("Exit status: 1\nUe_A { Bool(1) b(true);  System s();  Bool(3) a(true);  Unary(3) d(3);  Unsigned(6) e(3);  Int(32) test() {  a true cast = e d a cast cast 3 cast * cast = cast = s ( d )print . s ( e cast )print . b d cast 0 cast != = b cast return } }\nUq_System { <NOMAIN> }\n");
    }
