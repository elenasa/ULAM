...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3228_test_compiler_elementandquarkarray_EPelementlocal)
  {
    ...
    {
      return std::string("Exit status: 0\nUe_Foo { Bool(3) b(false);  Int(4) m_i(0);  typedef Bar Pop[2];  System s();  Bar m_bar2[2]( Bool(1) val_b[3](false,false,false);  Bool(1) val_b[3](false,false,false); );  Int(32) test() {  Foo f;  Atom(96) a;  a f spoon sbar 0 [] . . = f spoon sbar 1 [] . . a = 0 cast return } }\nUq_System { <NOMAIN> }\nUq_Bar { Bool(1) val_b[3](false,false,false);  <NOMAIN> }\nUe_Poo { Bool(3) b(false);  Int(4) m_i(0);  Bar sbar( Bool(1) val_b[3](false,false,false); );  <NOMAIN> }\n");
    }
