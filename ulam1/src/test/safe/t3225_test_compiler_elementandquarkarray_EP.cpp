...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3225_test_compiler_elementandquarkarray_EP)
  {
    ...
    {
      return std::string("Exit status: 0\nUe_Foo { Bool(3) b(false);  typedef Bar Pop[2];  System s();  Int(4) m_i(0);  Bar m_bar2[2]( Bool(1) val_b[3](false,false,false);  Bool(1) val_b[3](false,false,false); );  Int(32) test() {  Atom(96) a;  a sbar 0 [] = sbar 1 [] a = 0 cast return } }\nUq_System { <NOMAIN> }\nUq_Bar { Bool(1) val_b[3](false,false,false);  <NOMAIN> }\n");
    }
