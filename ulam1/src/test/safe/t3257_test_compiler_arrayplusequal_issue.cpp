...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3257_test_compiler_arrayplusequal_issue)
  {
    ...
    {
      return std::string("Ue_B { typedef Unsigned(8) Count;  typedef Unsigned(8) CountArray[4];  typedef Unsigned(2) Slot;  Unsigned(8) hitCount[4](1,0,0,0);  Int(32) test() {  ( 0 cast 1 cast )hit 0 cast return ; } }\nExit status: 0");
    }
