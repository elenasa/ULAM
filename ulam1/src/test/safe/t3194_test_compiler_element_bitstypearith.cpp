...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3194_test_compiler_element_bitstypearith)
  {
    ...
    {
      //Ue_Foo { Bits(3) m_i[3](1,2,3);  Bool(3) m_b[3](false,false,true);  Int(32) test() {  m_i 0 [] 1 cast = m_i 1 [] 2 cast = m_i 2 [] m_i 0 [] cast m_i 1 [] cast +b cast = m_b 0 [] m_i 0 [] cast = m_b 1 [] m_i 1 [] cast = m_b 2 [] m_i 2 [] cast = m_i 2 [] cast return } }\nExit status: 3
