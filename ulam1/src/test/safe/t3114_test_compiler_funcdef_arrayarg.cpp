...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3114_test_compiler_funcdef_arrayarg)
  {
    ...
    {
      //Ue_A { Int(32) d(1);  Int(32) test() {  Bool(1) mybool[3];  mybool 0 [] true cast = mybool 1 [] false cast = mybool 2 [] false cast = d ( 7 cast mybool )m = d return } }\nExit status: 1
      return std::string("Ue_A { System s();  Int(32) d(1);  Bool(7) sp(false);  Int(32) test() {  Bool(1) mybool[3];  mybool 0 [] true cast = mybool 1 [] false cast = mybool 2 [] false cast = d ( 7 cast mybool )m = s ( d )print . d return } }\nExit status: 1");
    }
