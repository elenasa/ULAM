...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3227_test_compiler_elementandquarkarray_EPelement)
  {
    ...
    {
      return std::string("Exit status: 0\nUe_Foo { Bool(3) b(false);  Int(4) m_i(0);  typedef Bar Pop[2];  System s();  Bar m_bar2[2]( Bool(1) val_b[3](false,false,false);  Bool(1) val_b[3](false,false,false); );  Int(32) test() {  Atom(96) a;  a spoon sbar 0 [] . = spoon sbar 1 [] . a = 0 cast return } }\nUq_System { <NOMAIN> }\nUq_Bar { Bool(1) val_b[3](false,false,false);  <NOMAIN> }\nUe_Poo { Bool(3) b(false);  Int(4) m_i(0);  Bar sbar( Bool(1) val_b[3](false,false,false); );  <NOMAIN> }\n");
    }
