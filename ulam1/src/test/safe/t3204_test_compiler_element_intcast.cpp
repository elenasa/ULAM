...
namespace MFM {
  ...
  BEGINTESTCASECOMPILER(t3204_test_compiler_element_intcast)
  {
    std::string GetAnswerKey()
    {
	 ...
	 Int(4) Arg: 0xf
       */
      return std::string("Exit status: -1\nUe_Foo { Bool(3) b(false);  System s();  Int(4) i(0);  Int(4) j(15);  Int(32) test() {  i 0 cast = j ( i cast cast 1 cast cast -b cast )update = s ( j cast )print . s ( j )print . j cast return } }\nUq_System { <NOMAIN> }\n");
    }
