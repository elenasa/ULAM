/**                                        -*- mode:C++ -*-
 * NodeBinaryOpBitwiseAnd.h - Node for handling Bitwise And for ULAM
 *
...
/**
  \file NodeBinaryOpBitwiseAnd.h - Node for handling Bitwise And for ULAM
...
namespace MFM{
  ...
  public:
    ...
    NodeBinaryOpBitwiseAnd(const NodeBinaryOpBitwiseAnd& ref);
    virtual ~NodeBinaryOpBitwiseAnd();
