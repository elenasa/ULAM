/**                                        -*- mode:C++ -*-
 * NodeBinaryOpLogicalAnd.h - Node for handling Logical And Operation for ULAM
 *
...
/**
  \file NodeBinaryOpLogicalAnd.h - Node for handling Logical And Operation for ULAM
...
#ifndef NODEBINARYOPLOGICALAND_H
#define NODEBINARYOPLOGICALAND_H

#include "NodeBinaryOpLogical.h"

namespace MFM{

  class NodeBinaryOpLogicalAnd : public NodeBinaryOpLogical
  {
  public:
...
#endif //NODEBINARYOPLOGICALAND_H
