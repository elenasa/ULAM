...
#define MAX_FILENAME_LENGTH (255 - 8)
  ...
  enum SYMBOLTYPEFLAG { STF_NEEDSATYPE = -2, STF_FUNCPARAMETER = -1, STF_DATAMEMBER = 0,  STF_FUNCLOCALVAR = 1, STF_FUNCARGUMENT = 2, STF_CLASSINHERITANCE = 3, STF_FUNCLOCALREF = 4, STF_CLASSPARAMETER = 5 };
