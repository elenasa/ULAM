...
#define ELE_TYPE u16
  ...
  enum SYMBOLTYPEFLAG { STF_NEEDSATYPE = -2, STF_FUNCPARAMETER = -1, STF_DATAMEMBER = 0,  STF_FUNCLOCALVAR = 1, STF_FUNCARGUMENT = 2, STF_CLASSINHERITANCE = 3, STF_CLASSPARAMETER = 4, STF_FUNCLOCALREF = 5, STF_FUNCLOCALCONSTREF = 6, STF_MEMBERCONSTANT = 7, STF_MEMBERTYPEDEF = 8, STF_RETURNSTMT = 9 };
  ...
  enum ALT { ALT_NOT = 0, ALT_AS, ALT_REF, ALT_CONSTREF}; //autolocaltype (not ALT_ARRAYITEM, )
